...
func (c *AppwriteClient) FileUpload(bucketID string, filePath string) (string, string, string, string, error) {
	...
	return fileURL, fileResponse.FileID, fileResponse.FileName, c.ProjectID, nil
}
